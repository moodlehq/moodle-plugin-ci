...
use Moodlerooms\MoodlePluginCI\PluginValidate\Requirements\RepositoryRequirements;
...
class RepositoryRequirementsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testResolveRequirements()
    {
        ...
        $this->assertInstanceOf(
            'Moodlerooms\MoodlePluginCI\PluginValidate\Requirements\RepositoryRequirements',
